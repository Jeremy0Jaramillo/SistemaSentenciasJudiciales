...
export class EvaluacionComponent implements OnInit {
  ...
  private isAppearanceComplete(): boolean {
    ...
    // Verificar la subsección específica según el vicio motivacional
    switch (appearance.motivationalHabit) {
      case 'incoherence':
        return this.isIncoherenceComplete()
      case 'inatinence':
        return this.isInatinenceComplete()
      case 'incomprehensibility':
        return this.isIncomprehensibilityComplete()
      case 'incongruity':
        return this.isIncongruityComplete()
      default:
        return false
    }
  }
